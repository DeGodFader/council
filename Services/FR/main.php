<div>
  ...
  <div class="card">
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <h4 style="font-weight:bold">Safety and Precautions</h4>
        </button>
      </h2>
    </div>
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
<div class="service">
                <h2 style=" font-weight:bold; text-align:center;" >Safety and Precautions</h2>
                <div class="container">
                    <div class="row">
                         <!-- List of links -->
                            <?php 
                                    $List=["Business Fire Safety", "Keeping Safe"];
                          ...
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/FR/2.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $item?>">
    ...
    <div class="card-header" id="headingTwo">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <h4 style="font-weight:bold">News and Services</h4>
        </button>
      </h2>
    </div>
...
<div class="service">
                ...
                <div class="container">
                    <div class="row">
                         <!-- List of links -->
                            <?php 
                                    $List=["News and Incidents", "Service Careers", "Contact Us"];
                                    $line=round((12/sizeof($List))+0.4);//sizeof($List);
                                    if($line>=6){$Space="col-lg-6 col-md-6";}
                                    else{$Space="col-lg-4 col-md-4";}
                                    $i=1;
