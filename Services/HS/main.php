...
<div class="accordion" id="accordionExample">
  <div class="card">
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <h4 style="font-weight:bold">Social Care</h4>
        </button>
      </h2>
    </div>
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
<div class="service">
                <h2 style=" font-weight:bold; text-align:center;" >Social Care</h2>
                <div class="container">
                    <div class="row">
                         <!-- List of links -->
                            <?php 
                                    $List=["Adult Social Care", "Children and Families"];
                          ...
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/HS/1.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $List[$i-1]?>">
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <h4 style="font-weight:bold">Health</h4>
        </button>
      </h2>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
<div class="service">
                <h2 style=" font-weight:bold; text-align:center;" >Health</h2>
                <div class="container">
                    <div class="row">
                         <!-- List of links -->
                            <?php 
                            ...
                            ?>
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/HS/2.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $List[$i-1]?>">
                                  <div class="service-item">
                                      <h3> <?php echo $item?>
                                      <i class="far fa-arrow-alt-circle-right"></i>
                                      </h3>
