  ...
  <div class="card">
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <h4 style="font-weight:bold">Business and Trading</h4>
        </button>
      </h2>
    </div>
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
         <!-- List of links -->
            <div class="service">
                <h2 style=" font-weight:bold; text-align:center;" >Business and Trading</h2>
                <div class="container">
                    <div class="row justify-content-center">
                         <!-- List of links -->
                            <?php 
                                    $List=["Business rates", "Trading Standards", "Business Fire Safety", "Business Support and Advice"];
                          ...
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/BTL/1.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $item?>">
  ...
  <div class="card">
    <div class="card-header" id="headingTwo">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <h4 style="font-weight:bold">Licences</h4>
        </button>
      </h2>
    </div>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
         <!-- List of links -->
            <div class="service">
                <h2 style=" font-weight:bold; text-align:center;" >Licences</h2>
                <div class="container">
                    <div class="row justify-content-center">
                         <!-- List of links -->
                            <?php 
                                    $List=["Licences","Request Licecnce's Copy", "Organizing an Event", "Food Registration and Approval"];
                                    $line=round((12/sizeof($List))+0.4);//sizeof($List);
                                    if($line>=6){$Space="col-lg-6 col-md-6";}
                                    else{$Space="col-lg-4 col-md-4";}
                                    $i=1;
                            ...
                            ?>
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/BS/2.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $item?>">
                                  <div class="service-item">
                                      <h3> <?php echo $item?>
                                      <i class="far fa-arrow-alt-circle-right"></i>
                                      </h3>
