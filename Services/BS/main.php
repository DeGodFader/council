    ...
    <div class="accordion" id="accordionExample">
                    ...
                    <div class="row">
                         <!-- List of links -->
                          ...
                          <div class="<?php echo $Space?> btn ">
                              <a href="Services/BS/1.php?M=<?php echo $i?>&&Service=<?php echo $Service->Name?>&&Page=<?php echo $item?>">
      ...
      <div class="card">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
          <div class="card-body">
            <div class="service">
                  <h2 style=" font-weight:bold; text-align:center;" >Support</h2>
                  <div class="container">
                    <div class="row">
                    <!-- List of links -->
                    <?php 
                            $List=["Council Tax Support", "Childcare Costs"];
                            $line=round((12/sizeof($List))+0.4);//sizeof($List);
                            if($line>=6){$Space="col-lg-6 col-md-6";}
                            else{$Space="col-lg-4 col-md-4";}
                            $i=1;
