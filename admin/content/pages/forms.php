                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center justify-content-center">
                        <a href="functions.php?d_form=<?php echo $F->ID?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit F">
                          Delete                        
                        </a>
                        <?php if(isset($_GET["d_user"])){if($F->ID==$_GET["d_user"]){?><i class="material-icons opacity-10">arrow_drop_down</i><?php } }?>
                        <?php if(isset($_GET["d_user"])){if($F->ID==$_GET["d_user"]){?>
